...
def get_parameter_groups(model):
    '''
    GPT: In most cases, it is sufficient to apply weight decay only to the weight parameters of linear layers and omit it for the bias term. This is the common practice followed in many deep learning models.
    '''
